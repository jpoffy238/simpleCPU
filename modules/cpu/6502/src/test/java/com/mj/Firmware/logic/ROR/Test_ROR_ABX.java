...
public class Test_ROR_ABX {
	private  CPU c;

	private static final Logger logger = LogManager.getLogger(Test_ROR_ABX.class);
	...
	@Test
	public void Test_ROL_ABSX_1() {
		int i = 0x1000;
		try {
			c.bus.write(i++,  OpCodes.LDX_IMM.code());
			c.bus.write(i++ ,(byte)(0x20));
			c.bus.write(i++, OpCodes.ROR_ABX.code());
	...
	@Test
	public void Test_ROL_ABX_CarrySet() {
		int i = 0x1000;
		try {
			c.bus.write(i++,  OpCodes.LDX_IMM.code());
			c.bus.write(i++ ,(byte)(0x20));

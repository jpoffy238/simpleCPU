...
public class CPU_CreateUtil {
	...
	public static CPU getCPU() {
		...
		rtc = new RTC(bus);
		bus.registerDevice(new basicMemory(bus, new AddressRange(0, 32 * 1024), null, 0));
		basicROM rom = new basicROM(bus, new AddressRange(0xf000, 0xffff), "RTCInt.hex", 0);
	...
	public static void load(PBus bus, String fileName, int startAddress)
			throws illegalAddressException, ROException, IOException, DeviceUnavailable {

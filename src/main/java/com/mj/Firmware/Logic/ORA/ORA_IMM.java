package com.mj.Firmware.Logic.ORA;
...
public class ORA_IMM extends Instruction {
	/*
	 * Affect Flags: none
	 * 
	...
	public ORA_IMM() {
		super((byte) (0x09));
		setProperty(KEY_MNEMONIC, "ORA");
		setProperty(KEY_ADDRESSING_MODE, VALUE_ADDM_IMM);
		setProperty(KEY_OPCODE, "0x09");
		setProperty(KEY_INSTRUCTION_SIZE, "2");
		setProperty(KEY_CYCLES, "2");
		setProperty(KEY_FLAGS_EFFECTED, "Z, N");
		setProperty(KEY_WEB, "http://6502.org/tutorials/6502opcodes.html#EOR");
		setProperty(KEY_DESCRIPTION, "Exclusive OR function.");

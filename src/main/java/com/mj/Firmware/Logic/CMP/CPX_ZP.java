...
public class CPX_ZP extends Instruction {
/*
 ...
 */
	public CPX_ZP () {
		super((byte)0xe4);
		setProperty(KEY_MNEMONIC, "CPX");
		setProperty(KEY_ADDRESSING_MODE, VALUE_ADDM_ZP);
		setProperty(KEY_OPCODE, "0xe4");
		setProperty(KEY_INSTRUCTION_SIZE, "2");
		setProperty(KEY_CYCLES, "3");
		setProperty(KEY_WEB,"http://6502.org/tutorials/6502opcodes.html#CPX" );
	...
	public void exeute(CPU c) throws illegalAddressException, DeviceUnavailable {
		...
		int absAddress = getZeroPageAddress(c);

...
public class Test_ROR_ZPX {
	private  CPU c;

	private static final Logger logger = LogManager.getLogger(Test_ROR_ZPX.class);
	...
	@Test
	public void Test_ROL_ZPX_CarrySet() {
		int i = 0x1000;
		try {

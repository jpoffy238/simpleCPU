...
public class Test_ROR_ACC {
	private  CPU c;

	private static final Logger logger = LogManager.getLogger(Test_ROR_ACC.class);
	...
	@Test
	public void Test_ROL_ACC_CarrySet() {
		int i = 0x1000;
		try {

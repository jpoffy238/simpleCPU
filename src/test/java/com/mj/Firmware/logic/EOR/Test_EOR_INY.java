...
public class Test_EOR_INY {
	private static CPU c;

	private static final Logger logger = LogManager.getLogger(Test_EOR_INY.class);
	...
	*/	 
		...
		try {
			...
			c.bus.write(i++, OpCodes.EOR_INY.code());
			c.bus.write(i++, (byte) (0x28));
